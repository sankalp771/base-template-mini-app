        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-4xl font-bold text-white">Story Progress Tree 🌳</h2>
            </div>
            <Button
                onClick={() => onNavigate("outcome")}
                className="bg-gradient-to-r from-pink-500 to-orange-500 hover:from-pink-600 hover:to-orange-600 font-semibold"
            >
              Finish Story →
            </Button>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-2 p-8 bg-white/95 backdrop-blur">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Branching Story Paths</h3>
                  ...
                  <div className="relative">
                    <div className="bg-gradient-to-r from-purple-400 to-pink-400 rounded-2xl p-4 shadow-lg max-w-xs">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-white font-semibold">{storyBranches[0].author}</span>
                        <span className="text-2xl">{storyBranches[0].mood}</span>
                      </div>
                      <p className="text-white text-sm font-medium">{storyBranches[0].text}</p>
                    </div>
                    ...
                    <div className="relative">
                      <div className="bg-gradient-to-r from-green-400 to-emerald-400 rounded-2xl p-4 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-white font-semibold">{storyBranches[1].author}</span>
                          <span className="text-2xl">{storyBranches[1].mood}</span>
                        </div>
                        <p className="text-white text-sm font-medium">{storyBranches[1].text}</p>
                      </div>
                      <CheckCircle2 className="absolute -top-2 -right-2 h-6 w-6 text-green-500 bg-white rounded-full" />
                    </div>
                  </div>
                    ...
                    <div className="relative">
                      <div className="bg-gradient-to-r from-cyan-400 to-blue-400 rounded-2xl p-4 shadow-lg border-2 border-cyan-300">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-white font-semibold">{storyBranches[2].author}</span>
                          <span className="text-2xl">{storyBranches[2].mood}</span>
                        </div>
                        <p className="text-white text-sm font-medium">{storyBranches[2].text}</p>
                        <Badge className="mt-2 bg-white text-cyan-600 font-semibold">AI Generated</Badge>
                      </div>
                      <CheckCircle2 className="absolute -top-2 -right-2 h-6 w-6 text-green-500 bg-white rounded-full" />
                    </div>
                  </div>
                    ...
                    <div className="relative opacity-60">
                      <div className="bg-gradient-to-r from-yellow-400 to-orange-400 rounded-2xl p-4 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-white font-semibold">{storyBranches[3].author}</span>
                          <span className="text-2xl">{storyBranches[3].mood}</span>
                        </div>
                        <p className="text-white text-sm font-medium">{storyBranches[3].text}</p>
                      </div>
                    ...
                    <div className="relative opacity-60">
                      <div className="bg-gradient-to-r from-red-400 to-pink-400 rounded-2xl p-4 shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-white font-semibold">{storyBranches[4].author}</span>
                          <span className="text-2xl">{storyBranches[4].mood}</span>
                        </div>
                        <p className="text-white text-sm font-medium">{storyBranches[4].text}</p>
                      </div>
                      <Lock className="absolute -top-2 -right-2 h-6 w-6 text-gray-400 bg-white rounded-full p-1" />
                    </div>
                  </div>
            ...
            <Card className="p-6 bg-white/95 backdrop-blur">
              ...
              <div className="space-y-4">
                {tasks.map((task, index) => (
                    ...
                    >
                      ...
                      <p className="font-semibold text-gray-900">{task.text}</p>
                      {task.status === "active" && (
                          <Button size="sm" className="w-full mt-2 bg-gradient-to-r from-purple-500 to-pink-500 font-semibold">
                            Complete Task
                          </Button>
                      )}
                    </div>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                <h4 className="font-bold text-gray-900 mb-3">Story Stats 📊</h4>
                <div className="space-y-2 text-sm font-medium">
                  <div className="flex justify-between">
                    <span className="text-gray-900">Total Branches:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-900">AI Contributions:</span>
                    <span className="font-bold text-gray-900">40% 🤖</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-900">Story Mood:</span>
                    <span className="font-bold text-gray-900">Mysterious 🤔</span>
                  </div>
                </div>
              </div>
            </Card>

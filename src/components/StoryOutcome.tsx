      ...
      <div className="max-w-5xl mx-auto space-y-6 relative z-10">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-4xl text-white drop-shadow-lg">Story Complete! 🎉</h2>
          </div>
        </div>
        ...
        <Card className="p-6 bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-500 text-white text-center">
          ...
          <p>You and your friends created an amazing story together!</p>
        </Card>

        {/* Story Display */}
        <Card className="p-8 bg-white/95 backdrop-blur">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl">The Epic Tale of Friendship 📖</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm">{line.author}</span>
                      {line.type === "ai" && (
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Button
            className="h-16 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white shadow-xl"
          ...
          <Button
            className="h-16 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white shadow-xl"
          ...
          <Button
            className="h-16 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-xl"
        ...
        <Card className="p-6 bg-white/95 backdrop-blur">
          <h3 className="text-xl mb-4">Story Creators 👥</h3>

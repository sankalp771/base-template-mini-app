      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 p-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-4xl font-bold text-white">Create Your Story Room 🎪</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="p-6 bg-white/95 backdrop-blur shadow-2xl">
              <div className="space-y-6">
                <div>
                  <Label htmlFor="room-name" className="font-bold text-gray-900">Room Name</Label>
                  <Input
                      id="room-name"
                      placeholder="Epic Adventure Awaits..."
                      value={roomName}
                      onChange={(e) => setRoomName(e.target.value)}
                      className="mt-2 bg-white font-medium"
                  />
                </div>

                <div>
                  <Label htmlFor="num-friends" className="font-bold text-gray-900">Number of Friends (1-6)</Label>
                  <Input
                      id="num-friends"
                      type="number"
                      min="1"
                ...
                <div>
                  <Label className="font-bold text-gray-900">Choose Genre</Label>
            ...
            <Card className="p-6 bg-white/95 backdrop-blur shadow-2xl">
                ...
                {joiningFriends.map((friend, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 font-medium">{friend.status}</div>
                      </div>
                      {friend.status === "ready" && (
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-lg border-2 border-cyan-300">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">AI Story Assistant</div>
                    <div className="text-sm text-gray-600 font-medium">Ready to help!</div>
                  </div>

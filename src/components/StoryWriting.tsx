      ...
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-3xl text-white">Story Writing Room ✨</h2>
          </div>
          <Button
        ...
        <div className="grid lg:grid-cols-4 gap-4">
          ...
          <Card className="lg:col-span-1 p-4 bg-white/95 backdrop-blur">
            ...
            {/* Mood Selector */}
            <div className="mt-6">
              <h3 className="mb-3">Story Mood</h3>
          ...
          <Card className="lg:col-span-3 p-6 bg-white/95 backdrop-blur">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl">The Epic Tale 📖</h3>
              ...
              <div className="relative">
                <Textarea
                  ...
                  className="min-h-[400px] bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-orange-200 p-4 text-base leading-relaxed"
